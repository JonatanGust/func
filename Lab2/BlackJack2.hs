...
exh1 = (Add (Card (Numeric 2) Hearts) (Add (Card Jack Spades) (Add (Card Ace Spades) Empty) ))
--Hand w/ val 15 4 cards
exh2 = (Add (Card (Numeric 3) Hearts) (Add (Card Jack Spades) (Add (Card Ace Spades) (Add (Card Ace Hearts) Empty)) ))
--Hand w/ val 23 3 cards
exh3 = (Add (Card (Numeric 3) Clubs) (Add (Card Jack Spades) (Add (Card King Diamonds) Empty) ))
